...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="icon" href="{{ asset('image/favicon.ico.png') }}">
    ...
    <header class="header">
        ...
        <button id="dark-mode-toggle" class="btn-darkmode">
            <i class="fa-solid fa-moon" id="dark-mode-icon"></i>
        </button>

        <button class="visit-btn" id="LoginBtn">Login</button>
    </header>
        ...
        <div class="about-container">
            ...
            <div class="info-box">
                ...
                <div class="text">
                    <h3>Hi, I'm</h3>
                    <h1>Hilmi Yahya</h1>
                    <span>Programmer | Dev</span>
                </div>

                <div class="btn-group">
                    <a class="btn" href="cv.pdf" download>Download CV</a>
                    <a class="btn" href="mailto:hyahyainspiration@gmail.com">Contact</a>
                </div>
...
<section id="experience" class="experience scroll-animate show">
    ...
    <div class="experience-info">
        ...
        <div class="profile-img">
            <img src="image/Image1.jpeg" alt="Profile Picture">
        </div>
    ...
    <div class="experience-card">
        <h2 class="experience-title">Languages</h2>
        <div class="skills-list">
            @foreach($skills->where('type', 'language') as $skill)
                <div class="skill">
                    <div class="skill-row">
    ...
    {{-- Frameworks --}}
    <div class="experience-card">
        <h2 class="experience-title">Frameworks</h2>
        <div class="skills-list">
            @foreach($skills->where('type', 'framework') as $skill)
                <div class="skill">
                    <div class="skill-row">
    ...
    {{-- Tools --}}
    <div class="experience-card">
        <h2 class="experience-title">Tools</h2>
        <div class="skills-list">
            @foreach($skills->where('type', 'tools') as $skill)
                <div class="skill">
                    <div class="skill-row">
    ...
    <section id="contact" class="contact scroll-animate show">
        <div class="input-box">
            ...
            <a class="btn" href="mailto:hyahyainspiration@gmail.com">Submit</a>
        </div>
    </section>
